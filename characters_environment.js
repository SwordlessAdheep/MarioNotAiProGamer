...
GameStatus= "start";
document.getElementById("status").innerHTML="game is 99.999999999999999991% loading";
...
console.log("noseX= "+noseX+"noseY= "+noseY);
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press play tah Play ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(15);
    text("Press SPCAE to Restart", gameConfig.screenX/2, gameConfig.screenY/2+135);
    textSize(40);
